...
class Twitter extends OAuth1
{
    ...
    {
        $parameters = array( 'cursor' => '-1') + $parameters;
    ...
    public function setUserStatus($status)
    {
        ...
        if (isset($status['picture'])) {
            $media = $this->apiRequest('https://upload.twitter.com/1.1/media/upload.json', 'POST', array(
                'media' => call_user_func('base64_encode',\Tools::file_get_contents($status['picture'])),
            ));

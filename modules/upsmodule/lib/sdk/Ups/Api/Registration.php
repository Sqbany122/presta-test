...
class Registration extends CommonHandle
{
    ...
    protected function resolveParam($args)
    {
        ...
        $this->writeLogDb('UpsAPIRegistration', __FILE__, __FUNCTION__, json_decode($result));
    ...
    protected function responseHandler($response)
    {
        ...
        $this->writeLogDb('UpsAPIRegistrationRes', __FILE__, __FUNCTION__, $data);

...
class PayUTools
{
     ...
     */
    public static function getSsecureTokenCartParams($cart)
    {
    ...
    public static function createCreateOrderStructFromCart(
        ...
        $openpayu_struct = array(
            ...
            'buyer' => array(
                ...
                'delivery' => array(
                    'street' => trim($address_delivery->address1.' '.$address_delivery->address2),
        ...
        if ($address_invoice->vat_number) {
            $openpayu_struct['buyer']['invoice'] = array(
                'street' => trim($address_invoice->address1.' '.$address_invoice->address2),

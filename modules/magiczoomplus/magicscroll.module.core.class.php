...
if (!defined('MAGICSCROLL_MODULE_CORE_CLASS_LOADED')) {
    ...
    class MagicScrollModuleCoreClass
    {
        ...
        public function getHeadersTemplate($jsPath = '', $cssPath = null, $linkModuleCss = true)
        {
            ...
            $headers = array();
            // add module version
            $headers[] = '<!-- Magic Zoom Plus Prestashop module version v5.9.14 [v1.6.71:v5.2.5] -->';
        ...
        {
            $params = array(
                'template'=>array('id'=>'template','group'=>'General','order'=>'20','default'=>'original','label'=>'Thumbnail layout','type'=>'array','subType'=>'select','values'=>array('original','bottom','left','right','top'),'scope'=>'module'),

<span style="font-size: 25px; font-family: 'times new roman', times;">
	...
	<table border="1" cellpadding="4" width="500px" >
		...
		<tr>
			<td>ADRES E-MAIL: {$address->email} {$customer->email}</td>
			<td>KOD POCZTOWY: {$address->postcode}</td>
		</tr>
		<tr>
			<td>TELEFON: {$address->phone} {$address->phone_mobile}</td>
...
<u>Numer konta bankowego</u>
	...
	<br />* Numer konta bankowego musi składać się z 26 cyfr, proszę dokładnie sprawdzić ten numer.<br />
	<br />
	...
	Sklep Internetowy Pegazshop.pl<br />
	ul.Zamkowa 2, II piętro<br />
	62-310 Pyzdry
	<br /><br />
	<table>
  <tr>
    <td align="justify" style="font-size: 18px; font-family: 'times new roman', times;">* ZWROTOWI NIE PODLEGAJĄ: Rzeczy dostarczone w zapieczętowanym opakowaniu, których po otwarciu opakowania nie można zwrócić, ze względu na ochronę zdrowia lub ze względów higienicznych, jeżeli po dostarczeniu opakowanie zostało otwarte przez Kupującego m.in: środki pielęgnacyjne, kosmetyki, suplementy, pasza, książki i czasopisma. Sprzedawca ponosi odpowiedzialność za wady produktów zgodnie z regulacjami wskazanymi w Kodeksie Cywilnym, w szczególności w art. 556 i następnych Kodeksu Cywilnego.</td>
  </tr>
</table><br />
	<table>
		<tr>

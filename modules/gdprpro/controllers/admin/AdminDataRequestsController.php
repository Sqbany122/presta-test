...
//        $this->bulk_actions = [
//            'fulfill' => [
//                'text'    => $this->l('Fulfill selected'),
//                'icon'    => 'icon-trash',
//                'confirm' => $this->l('Fulfill selected items?'),
//            ],
//        ];
		...
		IF(type = 1, '{$this->l('Request my data')}', '{$this->l('Delete my data')}') AS type_string,
        ...
        $this->fields_list = array(
            ...
            'type_string'     => array(
                ...
                'type'       => 'select',
                'list'       => array(
                    DataRequest::REQUEST_TYPE_EXPORT   => $this->l('Export'),
                    DataRequest::REQUEST_TYPE_DELETION => $this->l('Deletion'),
                ),
                'filter_key' => 'type',
                'color'      => 'color',
                'class'      => 'fixed-width-xs',
            ...
            'status'          => array(
                'title' => $this->l('Fulfillment status'),
                'type'  => 'bool',
                'align' => 'center',
            ),
        );
    ...
    public function renderForm()
    {
        ...
        $this->context->smarty->assign(array(
            ...
            'activities'           => \GdprActivityLog::activitiesByCustomer($this->customer->id),
        ));

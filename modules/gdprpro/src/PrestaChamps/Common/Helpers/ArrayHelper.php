...
class ArrayHelper
{
     ...
     * ```php
     * // working with array
     * $username = PrestaChamps\Common\Helpers\ArrayHelper::getValue($_POST, 'username');
     * // working with object
     * $username = PrestaChamps\Common\Helpers\ArrayHelper::getValue($user, 'username');
     * // working with anonymous function
     * $fullName = PrestaChamps\Common\Helpers\ArrayHelper::getValue($user, function ($user, $defaultValue) {
     *     return $user->firstName . ' ' . $user->lastName;
     * });
     * // using dot format to retrieve the property of embedded object
     * $street = PrestaChamps\Common\Helpers\ArrayHelper::getValue($users, 'address.street');
     * // using an array of keys to retrieve the value
     * $value = PrestaChamps\Common\Helpers\ArrayHelper::getValue($versions, ['1.0', 'date']);
     * ```
     *
    ...
    public static function getValue($array, $key, $default = null)
    {
        ...
        if (($pos = strrpos($key, '.')) !== false) {
            $array = static::getValue($array, \Tools::substr($key, 0, $pos), $default);
            $key = \Tools::substr($key, $pos + 1);
        }
        if (is_object($array)) {
     ...
     * // working with array
     * $type = PrestaChamps\Common\Helpers\ArrayHelper::remove($array, 'type');
     * // $array content
     * // $array = ['options' => [1, 2]];
     * ```
     *
     ...
     * $removed = PrestaChamps\Common\Helpers\ArrayHelper::removeValue($array, 'Jackson');
     * // result:
     ...
     * @param string|\Closure|null            $key    the column name or anonymous function which result will be used
     *                                                to index the array
     ...
     * ];
     *
     * $result = PrestaChamps\Common\Helpers\ArrayHelper::filter($array, ['A']);
     * // $result will be:
     * // [
     * //     'A' => [1, 2],
     * // ]
     *
     * $result = PrestaChamps\Common\Helpers\ArrayHelper::filter($array, ['A', 'B.C']);
     * // $result will be:
     * // [
     * //     'A' => [1, 2],
     * //     'B' => ['C' => 1],
     * // ]
     *
     * $result = PrestaChamps\Common\Helpers\ArrayHelper::filter($array, ['B', '!B.C']);
     * // $result will be:
     * // [
     * //     'B' => ['D' => 2],
     * // ]

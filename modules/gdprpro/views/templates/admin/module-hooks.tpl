                ...
                <div class="panel-group clearfix" id="accordion">
                    {foreach $modules_to_unhook as $name => $module}
                        {if Module::isInstalled($name)}
                            <div class="panel {if isset($module.checked) && $module.checked}panel-success{else}panel-default{/if} module-item-panel">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        {foreach $languages as $language}
                                                            <div class="translatable-field col_input lang-{$language.id_lang}"
                                                                 {if $language.id_lang != $defaultFormLanguage}style="display:none"{/if}>
                                                                <div class="col-lg-9 col_input">
                                                                    <input type="text"
                                                                ...
                                                                <div class="col-lg-3 col_language">
                                                                    <button type="button"

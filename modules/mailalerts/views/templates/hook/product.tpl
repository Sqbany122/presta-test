...
<!-- MODULE MailAlerts -->
<div style="padding:15px;border-radius:15px;border:3px solid #cda25e;margin:0 0 15px 0;">
<span class="h3" style="margin:0 0 15px 0;display:block;">Powiadomienie o dostępności produktu</span>
<form>
	{if isset($email) AND $email}
		<input type="text" style="border:1px solid #ddd;padding:5px;display:inline-block;" id="oos_customer_email" name="customer_email" size="20" value="{l s='your@email.com' mod='mailalerts'}" class="mailalerts_oos_email" onclick="clearText();" />
	{/if}

	{if isset($id_module)}
			{hook h='displayGDPRConsent' id_module=$id_module}
	{/if}
	<button type="submit" class="btn btn-default" style="background:#cda25e;color:#fff;display:inline-block;" title="{l s='Notify me when available' mod='mailalerts'}" onclick="return addNotification();" id="mailalert_link" rel="nofollow">{l s='Dodaj mój e-mail' mod='mailalerts'}</button>

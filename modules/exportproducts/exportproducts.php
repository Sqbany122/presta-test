  ...
  public function __construct(){
    ...
    $this->_exportTabInformation = array(
      ...
      array(
        ...
        'xml_head' => $this->l('id_pack_product_attribute'),
        'tab'   => 'exportTabInformation'
      ),
    );
      ...
      foreach($set as $value) {
        foreach ($newArray as $new) {
          if ($value == $new['name']) {
            ...
            $selected[$new['val']] = array('name' => $new['name'], 'hint' => $hint, 'tab' => $new['tab'], 'xml_head' => isset( $new['xml_head'] ) ? $new['xml_head'] : '');
          }
        }
      }
    }

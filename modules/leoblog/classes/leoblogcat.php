...
class Leoblogcat extends ObjectModel
{
    ...
    public function getTree($id = null, $id_lang = null, $id_shop = null, $active = false)
    {
        $childs = $this->getChild($id, $id_lang, $id_shop, $active);
    ...
    public function getDropdown($id, $selected = 1, $id_lang = null, $id_shop = null, $active = false)
    {
        $this->children = array();
        $childs = $this->getChild($id, $id_lang, $id_shop, $active);
        foreach ($childs as $child) {

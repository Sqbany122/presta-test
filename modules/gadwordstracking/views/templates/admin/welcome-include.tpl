...
<div class="col-xs-12 col-lg-12 pull-left">
	...
	<div id="modulenewsletterblock">
		<h3>{l s='Stay in touch with us' mod='gadwordstracking'}</h3>

		<p class="alert alert-info">{l s='Sign up to our newsletter and stay up-to-date on new modules, important updates and more !' mod='gadwordstracking'}</p>

		<div class="form-group">
			<label class="control-label col-xs-12 col-lg-1">
			</label>
			<div class="col-xs-12 col-lg-5 input-group">
				<span class="input-group-addon" id="basic-addon1">{l s='Your e-mail ' mod='gadwordstracking'}</span>
		...
		<div class="col-xs-12 col-lg-5">
			<button class="btn btn-info pull-right" name="dosignup" id="dosignup">{l s='Sign up !' mod='gadwordstracking'}</button>
		</div>
	...
	<div class="clr_10"></div>
	<h3>{l s='Follow Us' mod='gadwordstracking'}</h3>
	<div class="clr_10"></div>
...
<script type="text/javascript">
	...
	function display_confirmation_message(data)
	{
		...
		var msg_invalid_email = {/literal}'{l s="Sorry... The e-mail you have entered is invalid. Please double-check it." mod="gadwordstracking"}'{literal};
		var msg_invalid_language = {/literal}'{l s="Sorry... The language parameter is invalid. Please reload this page, try again and contact us if this problem persists." mod="gadwordstracking"}'{literal};
		var msg_duplicate = {/literal}'{l s="Your e-mail was already in our list, no need to enter it again. If you have unsubscribed directly from MailChimp, please contact us so we can add you there again manually" mod="gadwordstracking"}'{literal};
		var msg_unknown_error = {/literal}'{l s="Sorry... There was an unexpected error. Please reload this page, try again and contact us if this problem persists." mod="gadwordstracking"}'{literal};
		var msg_unknown_error_ajax = {/literal}'{l s="Sorry... There was an unexpected network error. Please reload this page, try again and contact us if this problem persists." mod="gadwordstracking"}'{literal};
		var msg_ok = {/literal}'{l s="Thank you ! You have been successfully added to our newsletter list." mod="gadwordstracking"}'{literal};

...
{block name=override_header}
	<div class="sensbitdpd sensbitdpd-parent">
		<div class="alert alert-info">
			...
			<p>Dla przesyłek w bazie sklepu o statusie, który ma poniżej włączoną opcję <strong>automatycznego sprawdzania statusu</strong> nasz moduł sprawdzi czy status w DPD się zmienił.</p>
			...
			<ol>
				...
				<li>Automatycznie w tle wyświetlając listę przesyłek DPD > Przesyłki.</li>
	...
	<script>
		...
		{if SensbitDpdTools::isBootstrap()}
			$(".sensbitdpd-parent").insertBefore("#form-sensbitdpd_status table.table");
		{else}

	...
	<div id="dpdpoland_shipment_creation"{if isset($smarty.get.scrollToShipment)} class="displayed-element"{/if}>
		...
		<div id="dpdpoland_recipient_address_container">
			...
			<div id="dpdpoland_recipient_address_selection_container">
				<label>{l s='Recipient address:' mod='dpdpoland'}</label>
				<div class="margin-form">
					<select id="dpdpoland_recipient_address_selection" name="dpdpoland_id_address_delivery" autocomplete="off">
		...
		<div>
            ...
            {if $settings->declared_value}
				<div id="dpdpoland_declared_value_amount_container">
					...
					<div class="margin-form">
						<input type="text" name="dpdpoland_DeclaredValue_amount" autocomplete="off" onchange="this.value = this.value.replace(/,/g, '.');" value="{if $package->declaredValue_amount}{$package->declaredValue_amount}{else}{$order_price_pl}{/if}" maxlength="14" size="11"> <span>{$smarty.const._DPDPOLAND_CURRENCY_ISO_}</span>
		...
		<div>
			<div id="dpdpoland_additional_info_container">
				...
				<div class="margin-form">
					<textarea name="additional_info" autocomplete="off" rows="4" cols="32">{if $package->additional_info}{$package->additional_info|escape:'htmlall':'UTF-8'}{elseif !$loaded_object}{$default_customer_data_1|escape:'htmlall':'UTF-8'}{/if}</textarea>
				</div>
			</div>
		...
		<div id="dpdgeopost_actions">
			<input type="button" id="save_and_print_labels" class="button" value="{l s='Save and print labels' mod='dpdpoland'}" />

			...
			<div id="dpdpoland_shipment_creation"{if isset($smarty.get.scrollToShipment)} class="displayed-element"{/if}>
				...
				<div class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
							<select class="client_number_select" id="dpdpoland_PayerNumber" name="dpdpoland_PayerNumber" autocomplete="off">
						...
						<div class="panel panel-sm clearfix" id="dpdpoland_sender_address_container">
							...
							<div class="form-group">
								<div class="col-lg-12">
									...
									<select class="col-lg-6 col-sm-6 col-xs-12" id="sender_address_selection" name="sender_address_selection" autocomplete="off">
						...
						<div class="panel panel-sm clearfix" id="dpdpoland_recipient_address_container">
							...
							<div class="form-group">
								<div class="col-lg-12">
									...
									<select class="col-lg-6 col-sm-6 col-xs-12" id="dpdpoland_recipient_address_selection" name="dpdpoland_id_address_delivery" autocomplete="off">
				...
				<div class="row form-horizontal">
                    ...
                    {if $settings->declared_value}
						<div class="form-group col-lg-6" id="dpdpoland_declared_value_amount_container">
							...
							<div class="input-group col-lg-5">
								<span class="input-group-addon">{$smarty.const._DPDPOLAND_CURRENCY_ISO_|escape:'htmlall':'UTF-8'}</span>
								<input type="text" name="dpdpoland_DeclaredValue_amount" autocomplete="off" onchange="this.value = this.value.replace(/,/g, '.');" value="{if $package->declaredValue_amount}{$package->declaredValue_amount}{else}{$order_price_pl}{/if}" maxlength="14" size="11">
							</div>
						</div>
					{/if}
                    ...
                    {if $settings->cud}
						<div class="form-group col-lg-6" id="dpdpoland_cud_container">
							<label for="dpdpoland_cud" class="control-label col-lg-5">
								{l s='Return parcel:' mod='dpdpoland'}
							</label>
							<div class="input-group col-lg-5">
								<input id="dpdpoland_cud" type="checkbox" name="cud" value="1"{if $package->cud} checked="checked"{/if}>
							</div>
						</div>
					{/if}

					{if $settings->rod}
						<div class="form-group col-lg-6" id="dpdpoland_rod_container">
							<label for="dpdpoland_rod" class="control-label col-lg-5">
								{l s='Return documents:' mod='dpdpoland'}
							</label>
							<div class="input-group col-lg-5">
								<input id="dpdpoland_rod" type="checkbox" name="rod" value="1"{if $package->rod} checked="checked"{/if}>
							</div>
						</div>
					{/if}
				</div>
				...
				<div class="row">
					<div class="form-group col-lg-6" id="dpdpoland_additional_info_container">
						...
						<div class="input-group col-lg-12 col-sm-12 col-xs-12">
							<textarea name="additional_info" autocomplete="off" rows="4">{if $package->additional_info}{$package->additional_info|escape:'htmlall':'UTF-8'}{elseif !$loaded_object}{$default_customer_data_1|escape:'htmlall':'UTF-8'}{/if}</textarea>
						</div>
					</div>
					...
					<div id="dpdpoland_shipment_references_container" class="col-lg-6">
						<div class="form-group">
							...
							<div class="input-group col-lg-4 col-xs-12">
								<input type="text" name="dpdpoland_ref1" autocomplete="off" value="{if $package->ref1}{$package->ref1|escape:'htmlall':'UTF-8'}{elseif !$loaded_object}{$default_ref1|escape:'htmlall':'UTF-8'}{/if}" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="input-group col-lg-4 col-xs-12">
								<input type="text" name="dpdpoland_ref2" autocomplete="off" value="{if $package->ref2}{$package->ref2|escape:'UTF-8'}{elseif !$loaded_object}{$default_ref2|escape:'htmlall':'UTF-8'}{/if}" />
							</div>
						</div>
					</div>
				</div>
				...
				<table width="100%" cellspacing="0" cellpadding="0" class="table row" id="dpdpoland_shipment_products">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<select class="parcel_selection" name="dpdpoland_products[{$smarty.foreach.products.index|escape:'htmlall':'UTF-8'}][parcel]" autocomplete="off">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<input type="text" name="parcels[{$parcel.number|escape:'htmlall':'UTF-8'}][content]" size="46" autocomplete="off" value="{$parcel.content|escape:'htmlall':'UTF-8'}" />
									<p class="preference_description clear">{l s='Modified field' mod='dpdpoland'}</p>
								</td>
								<td>
									<input type="text" name="parcels[{$parcel.number|escape:'htmlall':'UTF-8'}][weight]" size="10" autocomplete="off" value="{$parcel.weight|escape:'htmlall':'UTF-8'}" />
									<p class="preference_description clear">{l s='Modified field' mod='dpdpoland'}</p>
								</td>
								<td>
									<input type="text" name="parcels[{$parcel.number|escape:'htmlall':'UTF-8'}][height]" size="10" autocomplete="off" value="{$parcel.height|escape:'htmlall':'UTF-8'}" />
									<p class="preference_description clear">{l s='Modified field' mod='dpdpoland'}</p>
								</td>
								<td>
									<input type="text" name="parcels[{$parcel.number|escape:'htmlall':'UTF-8'}][length]" size="10" autocomplete="off" value="{$parcel.length|escape:'htmlall':'UTF-8'}" />
									<p class="preference_description clear">{l s='Modified field' mod='dpdpoland'}</p>
								</td>
								<td>
									<input type="text" name="parcels[{$parcel.number|escape:'htmlall':'UTF-8'}][width]" size="10" autocomplete="off" value="{$parcel.width|escape:'htmlall':'UTF-8'}" />
									<p class="preference_description clear">{l s='Modified field' mod='dpdpoland'}</p>
								</td>
				...
				<div class="row">
					...
					<div id="dpdgeopost_actions" class="form-horizontal">
						...
						<div class="col-lg-5">
							<button class="btn btn-default pull-right" id="save_and_print_labels" type="button"><i class="process-icon-save"></i> {l s='Save and print labels' mod='dpdpoland'}</button>
							<button class="btn btn-default pull-right" id="save_labels" type="button"><i class="process-icon-save"></i> {l s='Save' mod='dpdpoland'}</button>
							<button class="btn btn-default pull-right{if !$package->id_package_ws} hidden-element{/if}" id="print_labels" type="button"><i class="process-icon-save-status"></i> {l s='Print labels' mod='dpdpoland'}</button>
						</div>
					</div>
				</div>
			</div>

...
require_once(_PS_MODULE_DIR_.'/simpleprintordertopdf/model/CustomPdf.php');

class SimplePrintOrderToPdfController extends ModuleAdminController 
{
...
//			$pdf_order_obj['customer'] = $customer;

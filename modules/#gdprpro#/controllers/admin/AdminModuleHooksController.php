...
class AdminModuleHooksController extends ModuleAdminController
{
    ...
    public function initContent()
    {
        ...
        $this->informations[] =
            $this->module->l("Pick and choose which module(s) can be disabled by your website's visitors. 
            When you chek \"Unhook\" the module will be displayed in the pop-up with all the information entered 
            and a checkbox where customers can choose if they want to continue on the website with or without the 
            module being active. Please provide relevant information in order for customers to make an informed 
            decision. Also, if disabling certain modules affects the functionality of the website, please make 
            sure to add this information in the description box.");

...
{if isset($subscribers) && count($subscribers) > 0}
    <script>
        var ajax_subscription_page_link = "{$ajax_subscription_page_link nofilter}"; {* variable contains html,url content can not escape*}
        var notification_title = "{l s='Notification' mod='backinstock'}"
    </script>
{/if}

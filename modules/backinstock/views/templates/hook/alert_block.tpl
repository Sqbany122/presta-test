                ...
                <div class="back_left">
                    <div id="email_data_back" class="pal_popup_product_email_row_back">
                                    ...
                                    {foreach $kb_available_field as $kbfield}
                                        {if $kbfield['type'] == 'text'}
                                            <div class="form-group row" >
                                                <label style="color:{$text}" for="{$kbfield['field_name']|escape:'htmlall':'UTF-8'}" class="col-md-3 form-control-label {if $kbfield['required']}required{/if}">{$kbfield['label']|escape:'htmlall':'UTF-8'}</label>
                                                <div class="col-md-12">
                                                    <input type="{if $kbfield['validation'] == 'isEmail'}email{else}text{/if}" {if $kbfield['placeholder'] != ''}placeholder="{$kbfield['placeholder']|escape:'htmlall':'UTF-8'}"{/if} 
                                                           ...
                                                           />
                                                    {if $kbfield['error_msg'] != ''}<p class="error_message" style="display:none;">{$kbfield['error_msg']|escape:'htmlall':'UTF-8'}</p>{/if}
                                                </div>
                                            </div>
                                        {/if}
                                        {if $kbfield['type'] == 'select'}
                                            <div class="form-group row">
                                                <label style="color:{$text}"  for="{$kbfield['html_id']|escape:'htmlall':'UTF-8'}" class="col-md-3 form-control-label {if $kbfield['required']}required{/if}">{$kbfield['label']|escape:'htmlall':'UTF-8'}</label>
                                                <div class="col-md-6">
                                                    <select name='{$kbfield['field_name']|escape:'htmlall':'UTF-8'}' id='{$kbfield['html_id']|escape:'htmlall':'UTF-8'}' class="kbfield {$kbfield['html_class']|escape:'htmlall':'UTF-8'} {if $kbfield['required']}is_required{/if} form-control"
                                                             >
                                                        {if $kbfield['value'] != ''}
                                        ...
                                        {if $kbfield['type'] == 'radio'}
                                            <div class="form-group row">
                                                <label style="color:{$text}" class="col-md-3 form-control-label {if $kbfield['required']}required{/if}">{$kbfield['label']|escape:'htmlall':'UTF-8'}</label>
                                                <div class="col-md-12">    
                                        ...
                                        {if $kbfield['type'] == 'checkbox'}
                                            <div class="form-group row">
                                                <label style="color:{$text}" class="col-md-3 form-control-label {if $kbfield['required']}required{/if}">{$kbfield['label']}</label>
                                                <div class="col-md-12">
                                        ...
                                        {if $kbfield['type'] == 'textarea'}
                                            <div class="form-group row">
                                                <label style="color:{$text}"  data-require= "{$kbfield['required']}" class="col-md-3 form-control-label {if $kbfield['required']}required{/if}" for="{$kbfield['html_id']}">{$kbfield['label']}</label>
                                                <div class="col-md-12">
                        ...
                        <div  id="notify_quantity_back" class="" style="width:100%; ">
                            <input type="number" id='user_quantity_subscribe_back' style="padding-top: 5px" class="form-control" name="customer_quantity_back" placeholder="{l s='5' mod='backinstock'}" value=0 />
                        </div>
                        {/if}
                        <div class="pal_small_input_row pal_email_label" style="width:20%;color:{$text}">{l s='Email:' mod='backinstock'}</div>
                        <div  id="notify_email_back" class="pal_small_input_row pal_email_input_back" style="width:55%;">
                            <input type="text" id='user_email_subscribe_back' class="form-control" {if $disabled == 1 } readonly {else} {/if} name="customer_email_back" placeholder="{l s='Email' mod='backinstock'}" value='{$customer['email']}' />
                        </div>
                        ...
                        <div class="notifyButton">
                            <button  type="submit" id="save_subscribe_back" class="btn btn-primary" onclick="return save_subscribe_data_back()" style="color:{$notify_text} !important;background:{$notify_background} !important;border-color: {$notify_border} !important;">

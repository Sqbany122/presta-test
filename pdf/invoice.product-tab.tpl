...
<table class="product" width="100%" cellpadding="4" cellspacing="0">
	...
	<tr>
		...
		<th class="product header small" width="{$layout.ean.width}%" >EAN</th>
		...
		<th class="product header-right small" width="{$layout.total_tax_excl.width}%">{l s='Total' pdf='true'} <br />(brutto)</th>
	</tr>
	</thead>

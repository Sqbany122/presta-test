<div id="opc_new_account" class="opc-main-block">
    ...
    <form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
        <fieldset>
            ...
            <p><a href="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" id="openLoginFormBlock"><span><i class="icon-user left"></i></span> {l s='Click here'}</a></p>
            ...
            <div class="box">
                ...
                <div id="opc_account_choice" class="row">
                    <div class="col-xs-12 col-md-6">
                        <p class="opc-button">
                            <button type="submit" class="btn btn-default button button-medium exclusive" id="opc_guestCheckout"><span><i class="fa fa-shopping-cart"></i> {l s='Guest checkout'}</span></button>
                        </p>
                    </div>
                    <div class="col-xs-12 col-md-6">
                        <p class="opc-button">
                ...
                <div id="opc_account_form" class="unvisible">
                    ...
                    <div id="opc_invoice_address" class="is_customer_param">
                        ...
                        {foreach from=$inv_all_fields item=field_name}
                            ...
                            {elseif $field_name eq "address1"}
                                <div class="required form-group">
                                    <label for="address1_invoice">{l s='Dokładny adres siedziby'} <sup>*</sup></label>
                    ...
                    <div class="submit opc-add-save clearfix">
                        <button type="submit" name="submitAccount" id="submitAccount" data-adv-api="1" class="btn btn-default button button-medium"><span>{l s='Zatwierdź dane'}<i class="icon-chevron-right right"></i></span></button>

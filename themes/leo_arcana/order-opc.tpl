...
$( document ).ready(function() {
	$('#customer_firstname').change(function() {
		$('#firstname_invoice').val($(this).val());
	});
	$('#customer_lastname').change(function() {
		$('#lastname_invoice').val($(this).val());
	});
	...
	$('#address1').change(function() {
		$('#address1_invoice').val($(this).val());
	});
	$('#postcode').change(function() {
		$('#postcode_invoice').val($(this).val());
	});
	$('#city').change(function() {
		$('#city_invoice').val($(this).val());
	});
	$('#phone_mobile').change(function() {
		$('#phone_mobile_invoice').val($(this).val());
	});
});
</script>
{/literal}

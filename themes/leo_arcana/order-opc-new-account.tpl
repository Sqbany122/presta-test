<div id="opc_new_account" class="opc-main-block">
	...
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="box form-horizontal">
		<fieldset>
			...
			<p><a href="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" id="openLoginFormBlock" class="btn"><span><i class="fa fa-user left"></i></span> {l s='Click here'}</a></p>
			...
			<div class="box">
				...
				<div id="opc_account_choice" class="row">
					<div class="col-xs-12 col-md-6">
						<p class="opc-button">
							<button type="submit" class="btn btn-outline button button-medium exclusive" id="opc_guestCheckout"><span><i class="fa fa-shopping-cart"></i> {l s='Guest checkout'}</span></button>
						</p>
					</div>
					<div class="col-xs-12 col-md-6">
						<p class="opc-button">
				...
				<!--<div class="form-group">
					...
					<!--<div id="vat_number_block" style="display:none;">
						<div class="form-group">
						<label class="control-label col-sm-4 col-md-4" for="vat_number">{l s='NIP'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
						<div class="col-sm-6 col-md-6">
					...
					<div class="required text form-group">
					<label class="control-label col-sm-4 col-md-4" for="address2">{l s='Address (Line 2)'} <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">
					...
					<div class="required select form-group" style="opacity:0;overflow:hidden;height:1px;">
					...
					<!--<div class="form-group is_customer_param">
					<label class="control-label col-sm-4 col-md-4" for="phone">{l s='Numer telefonu'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>**</sup>{/if}</label>
					<div class="col-sm-6 col-md-6">
					...
					<label class="control-label col-sm-4 col-md-4" for="phone_mobile">{l s='Nr telefonu'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>**</sup>{/if}</label>
					<div class="col-sm-6 col-md-6">
				...
				<div class="form-group">
					...
					<div class="checkbox">
						...
						{l s='Chcę użyć danych firmowych do faktury'}</label>
						</div>
					</div>
					</div>
					...
					<div id="opc_invoice_address" class="is_customer_param">
						...
						{elseif $field_name eq "vat_number"}
						<div id="vat_number_block_invoice" class="is_customer_param" style="display:block!important;">
							<div class="form-group">
							<label class="control-label col-sm-4 col-md-4" for="vat_number_invoice">{l s='NIP'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
							<div class="col-sm-6 col-md-6">
						...
						{elseif $field_name eq "firstname"}
						<div class="required form-group unvisible" style="opacity:0;overflow:hidden;height:0px;">
					...
					{elseif $field_name eq "address1"}
					<div class="required form-group">
						<label class="control-label col-sm-4 col-md-4" for="address1_invoice">{l s='Dokładny adres siedziby'} <sup>*</sup></label>
						<div class="col-sm-6 col-md-6">
					...
					<input type="text" name="address2_invoice" value=" " style="display:none;opacity:0;" for="address2_invoice" id="address2_invoice" />
					{elseif $field_name eq "address2"}
					...
					<div class="required form-group unvisible" style="opacity:0;overflow:hidden;height:0px;">
						...
						{/if}
						<div class="form-group is_customer_param unvisible" style="opacity:0;overflow:hidden;height:0px;">
						...
						<div class="col-sm-6 col-md-6">
							<input type="text" class="form-control validate unvisible" name="phone_invoice" id="phone_invoice" data-validate="isPhoneNumber" value="{if isset($guestInformations) && isset($guestInformations.phone_invoice) && $guestInformations.phone_invoice}{$guestInformations.phone_invoice}{/if}" />
						</div>
					</div>!-->
						<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group unvisible" style="opacity:0;overflow:hidden;height:0px;">
						<label class="control-label col-sm-4 col-md-4" for="phone_mobile_invoice">{l s='Nr telefonu'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>*</sup>{/if}</label>
						<div class="col-sm-6 col-md-6">
					...
					<div class="submit opc-add-save clearfix">
						<button type="submit" name="submitAccount" id="submitAccount" class="btn btn-outline button button-medium"><span>{l s='Zatwierdź dane'}</span></button>

				...
				{if isset($delivery_option_list)}
					{foreach $delivery_option_list as $id_address => $option_list}
						<p class="carrier_title">
							...
							{/if}
							{*<br><div style="text-align:center;font-weight:normal;font-size:12px;display:block;color:#fff;background:#e36767;padding:5px;">W okresie od 18.12.2019 do 10.01.2020 wysyłka zamówionych produktów będzie realizowana z opóźnieniem. Za niedogodności przepraszamy.
							<hr style="margin:10px;color:transparent;">
							Szanowni Klienci, prosimy o indywidualny kontakt w przypadku chęci gwarancji otrzymania zamówionych produktów do dnia 24.12.2019.</div>*}
						</p>
						<div class="delivery_options">
							{foreach $option_list as $key => $option}
								<div class="delivery_option {if ($option@index % 2)}alternate_{/if}item">
									<div>
										<table class="resume table-responsive table table-bordered">
											<tr>
												...
												<td>
													{if $option.unique_carrier}
														...
														{/if}
													{else}
Twoje zamówienie zostało rozłożone na kilka przesyłek z różnych magazynów. Czas dostawy paszy może się wydłużyć.
													{/if}
												</td>

...
{/if}
	<div id="cart" class="shopping_cart pull-right">
			<a class="heading" href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
				<div class="cart-inner media-body">
					<h4 class="title-cart">{l s='Koszyk' mod='blockcart'}</h4> 
...
<div class="userinfo-selector links dropdown js-dropdown popup-over float-xs-right float-md-right hidden-lg-up">    
  <a href="/moje-konto" class="signin  leo-quicklogin dropdown-item" data-enable-sociallogin="enable" data-type="popup" data-layout="login" title="Moje konto klienta">
    <i class="icomoon icon-author"></i>
 </a>
  <ul class="popup-content dropdown-menu user-info">
{if $logged}
          <li>
        <a class="dropdown-item" href="/moje-konto" title="Moje konto" rel="nofollow">
          <span>Moje konto</span>
        </a>
      </li>
          <li>
        <a class="dropdown-item"" href="/module/blockwishlist/mywishlist" title="Moja lista życzeń" rel="nofollow">
          <span>Moja lista życzeń</span>
        </a>
      </li>
          <li>
        <a class="dropdown-item"" href="/?mylogout" title="Wyloguj się" rel="nofollow">
          <span>Wyloguj się</span>
        </a> 
      </li>
{else}
          <li>
        <a class="dropdown-item"" href="/moje-konto" title="Zaloguj się do swojego konta klienta" rel="nofollow">

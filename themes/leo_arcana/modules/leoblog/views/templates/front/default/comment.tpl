...
<div id="blog-localengine">
		<form class="form-horizontal" method="post" id="comment-form" action="{$blog_link}" onsubmit="return false;">
			...
			<div class="form-group">
			 ...
			 <div class="form-group">
			 	 <img src="{$captcha_image}" alt="" align="left"/>
				 <input class="form-control" type="text" name="captcha" value="" size="10" />
			 </div>
			 <input type="hidden" name="id_leoblog_blog" value="{$id_leoblog_blog}">
			<div class="form-group">
					<div class="col-lg-9 col-lg-offset-3"><button class="btn btn-outline" name="submitcomment" type="submit">{l s='Submit' mod='leoblog'}</button></div>
			</div>
		</form>
</div>
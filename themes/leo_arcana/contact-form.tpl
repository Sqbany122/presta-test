		...
		<fieldset>
			...
			<div class="clearfix">
				<div class="col-xs-12 col-md-3">
					<div class="form-group selector1" style="display:none;}>
						<label for="id_contact">{l s='Subject Heading'}</label>

						<select id="id_contact" class="form-control" name="id_contact">
							<option value="3">Obsługa Klienta</option>
						</select>

					</div>
					<p class="form-group">
						<label for="email">{l s='Twój adres e-mail'}</label>

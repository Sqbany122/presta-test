...
{if $errors|@count == 0}
	...
	#center_column.col-md-9{width:100%!important;}
	</style>
	{/literal}
	...
	<div class="primary_block row">
		...
		<div class="pb-center-column col-xs-12 col-sm-12 col-md-6 col-lg-6">			
			...
			<div style="padding-bottom:15px;">
				Indeks produktu: {$product->reference}
			</div>
...
{literal}<style>
.infop{display:none;}
.infop:last-child{display:block!important;}
</style>{/literal}
...
<div style="display:block;"><i class="fa fa-truck" style="float:left;font-size:32px;margin-right:10px;"></i><span style="color:#000;font-size:21px;font-weight:bold;line-height:28px;">Wysyłka <span style="line-height:14px;color:green;font-size:21px;font-weight:bold;">7 - 30 dni</span></span></div>
{break}
	{/if}
{/foreach}

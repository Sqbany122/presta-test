...
<html{if isset($language_code) && $language_code} lang="{$language_code|escape:'html':'UTF-8'}"{/if} {if isset($IS_RTL) && $IS_RTL} dir="rtl" class="rtl{if isset($LEO_DEFAULT_SKIN)} {$LEO_DEFAULT_SKIN}{/if}" {else} class="{if isset($LEO_DEFAULT_SKIN)}{$LEO_DEFAULT_SKIN}{/if}" {/if}>
	...
	<head>
		...
		{/if}
		{literal}
<meta name="facebook-domain-verification" content="9rpuyelav9po125dnngxyl4z81ehdl" />
<!-- Google Tag Manager -->
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-K3N8DLK');</script>
<!-- End Google Tag Manager -->
		...
		{if isset($LAYOUT_WIDTH)}
                {$LAYOUT_WIDTH}
		{/if}
		<link rel="stylesheet" href="//fonts.googleapis.com/css?family=Raleway:400,600,500,700,800,900,300" type="text/css" media="all" />
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K3N8DLK"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->
	{/literal}
{*
<div style="background:green;width:100%;padding:4px 0px;text-align:center;color:#fff;font-weight:bold;">Organizujemy KONKURS z okazji dnia dziecka, <a href="https://www.facebook.com/pegaz.poznan/" style="color:#fff;" target="_blank" rel="nofollow">wejdź na nasz Facebook</a></div>
*}
		...
		<section id="page" data-column="{$colValue}" data-type="{$LISTING_GRIG_MODE}">
			...
			<section id="columns" class="container">
				...
				{/if}				
						...
						{/if}
						{if isset($left_column_size) && isset($right_column_size)}{assign var='cols' value=(12 - $left_column_size)}{else}{assign var='cols' value=12}{/if}
						<!-- Center -->

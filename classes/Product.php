...
class ProductCore extends ObjectModel
{
    ...
    */
        ...
        $id_customer = 0, $use_customer_price = true, $id_cart = 0, $real_quantity = 0)
    {
		...
		if(isset($context->cookie->CustomPromotionCategoryProduct))
		{
			$customPromotionCategoryProduct = json_decode($context->cookie->CustomPromotionCategoryProduct, true);
			if(isset($customPromotionCategoryProduct[$id_product])){
				
				return $customPromotionCategoryProduct[$id_product];
			}
		}
